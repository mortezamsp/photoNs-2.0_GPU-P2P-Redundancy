...
void LogMessage(int loop, double a, double time_short, double time_pm, double time_total, double imbalance) {
	if (0== PROC_RANK) {
		...
		fprintf(flog, "%5d %3d  %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %F \n", 
...
void initializeLogfile() {
	if (0== PROC_RANK) {
		...
		fprintf(flog, "###n,lvl,imbalance a_t,dTpm,dTshort,dTp2p_self,dTp2p_others,dTp2p_collect,dTm2l,dTfmm,dText,Ttot \n");
