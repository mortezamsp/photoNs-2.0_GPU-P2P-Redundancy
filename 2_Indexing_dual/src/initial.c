...
// extern "C" {
//     void get_local_size_(int *nside, int *vproc, int *local_xstart, int *local_xend, int *local_xsize);
//     // Add other Fortran functions you are calling in a similar manner
// }
